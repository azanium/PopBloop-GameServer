...
namespace Exitgames.Realtime.Policy.Application
{
    ...
    ///   Application serving policy files in response of FlashPlayer requests.
    /// </summary>
    public class Policy : IPhotonApplication, IPhotonApplicationControl
    {
        ...
        /// </returns>
        public IPhotonApplication OnStart(string instanceName, string applicationName, IPhotonApplicationSink sink, IControlListeners listenerControl, string unmanagedLogDirectory)
        {
